...
public abstract class ProxyConnection implements Connection
{
   ...
   {
      return PROXY_FACTORY.getProxyStatement(this, trackStatement(delegate.createStatement()));
   }
   ...
   {
      return PROXY_FACTORY.getProxyStatement(this, trackStatement(delegate.createStatement(resultSetType, concurrency)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyStatement(this, trackStatement(delegate.createStatement(resultSetType, concurrency, holdability)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyCallableStatement(this, trackStatement(delegate.prepareCall(sql)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyCallableStatement(this, trackStatement(delegate.prepareCall(sql, resultSetType, concurrency)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyCallableStatement(this, trackStatement(delegate.prepareCall(sql, resultSetType, concurrency, holdability)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, autoGeneratedKeys)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, resultSetType, concurrency)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, resultSetType, concurrency, holdability)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, columnIndexes)));
   }
   ...
   {
      return PROXY_FACTORY.getProxyPreparedStatement(this, trackStatement(delegate.prepareStatement(sql, columnNames)));
   }
   ...
   public DatabaseMetaData getMetaData() throws SQLException
   {
      ...
      return PROXY_FACTORY.getProxyDatabaseMetaData(this, delegate.getMetaData());
   }
